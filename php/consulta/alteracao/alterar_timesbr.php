...
$dado = $_GET['id'];
$consulta = "SELECT * FROM timesbr WHERE nome_time='$dado'";
if ($res = mysqli_query($conn, $consulta)) {
  while ($linha = mysqli_fetch_array($res)) {
    echo '
    <form id="form1" name="form1" method="post" action="update_timesbr.php?id='.$dado.'">
    ...
    <tr>
    <td><span class="altera">Nome do time:</span></td>
    <td><label>
    <input name="nome_time" type="text" id="nome_time" value="'.$linha["nome_time"].'"/>
    </label></td>
    </tr>
